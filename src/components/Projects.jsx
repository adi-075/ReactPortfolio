...
const Projects = () => {
    return(
        <div style={{"height":"750px"}} id="projects">
            ...
            <div className='flex'>
            <a href="https://github.com/atharvpatwardhan/StockMarketPrediction"><img src = {stock} alt="stock market prediction" className='hover:scale-110 hover:bg-gradient-to-r from-red-600 to-orange-500' style={{"marginLeft":"80%","marginTop":"40%","height":"250px","borderRadius":"20%"}}/></a>
